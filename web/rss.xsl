...
<xsl:output omit-xml-declaration="no" method="rss" doctype-public="-//W3C//DTD XHTML 1.0 Strict//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd" indent="yes" encoding="UTF-8" />
...
<xsl:when test="listeners">
 <item>
  ...
  <link>http://fm.hackcoop.com.ar<xsl:value-of select="@mount" /></link>
 </item>
</xsl:when>
</xsl:choose>
</xsl:for-each>
