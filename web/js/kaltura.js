...
window['SCRIPT_LOADER_URL']='http://cdnakmi.kaltura.org/apis/html5versions/1.6.12.21/ResourceLoader.php';

window['KALTURA_LOADER_VERSION']='1.6.12.21c';(function(){"use strict";var kWidget={readyWidgets:{},readyCallbacks:[],destroyedWidgets:{},perWidgetCallback:{},setup:function(){var _this=this;this.checkEnvironment();this.overrideFlashEmbedMethods();this.proxyJsCallbackready();this.domReady(function(){_this.proxyJsCallbackready();});this.domReady(function(){_this.rewriteObjectTags();});},checkEnvironment:function(){if(document.URL.indexOf('forceMobileHTML5')!==-1&&!mw.getConfig('disableForceMobileHTML5')){mw.setConfig('forceMobileHTML5',true);}
